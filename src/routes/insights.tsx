    ...
    return {
      meta: [
        { title: "News & Insights — Kenyan Legal Guides | P&A Advocates LLP" },
        {
          name: "description",
          content:
            "Legal insights and guides from P&A Advocates LLP on Kenyan law — conveyancing, employment, succession, corporate and commercial practice.",
        },
        { property: "og:title", content: "News & Insights — P&A Advocates LLP" },
        {
          property: "og:description",
          content: "Legal insights, guides, and commentary from P&A Advocates LLP.",
        },
    ...
    <div>
      ...
      <section className="bg-cream-veil py-6 px-6 border-b border-brand-gold/25">
        <div className="max-w-6xl mx-auto flex flex-wrap justify-center gap-2 md:gap-3">
          <span className="text-[10px] tracking-[0.3em] uppercase text-brand-green/80 px-3 py-2">
            Topics:
          </span>
          {categories.map((c) => (
            <span
      ...
      {featured && (
        <section className="bg-cream-veil py-16 md:py-20 px-6">
          <div className="max-w-6xl mx-auto">
            <p data-reveal className="text-brand-gold text-[10px] tracking-[0.35em] uppercase mb-6">
              Featured Insight
            </p>
            <Link
              to="/insights/$slug"
            ...
            >
              <div
                data-reveal
                className="md:col-span-7 relative aspect-[16/10] overflow-hidden rounded-sm"
              >
                <img
                ...
                <div
                  aria-hidden
                  className="absolute inset-0 bg-gradient-to-tr from-brand-green/50 via-transparent to-transparent"
                />
              </div>
              <div data-reveal data-reveal-delay="120" className="md:col-span-5">
                <p className="text-brand-gold text-[10px] tracking-[0.3em] uppercase mb-4">
                  {featured.category}
                </p>
      ...
      <section className="py-16 md:py-24 px-6 bg-brand-offwhite">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-baseline justify-between mb-10 md:mb-12">
            <h2
              data-reveal
              className="font-display text-2xl md:text-3xl text-brand-green font-semibold"
            >
              More Insights
            </h2>
            <span
              data-reveal
              className="text-[10px] tracking-[0.3em] uppercase text-brand-green/70"
            >
            ...
            {rest.map((a, i) => (
              ...
              >
                <div className="aspect-[16/10] bg-brand-green/10 overflow-hidden relative">
                  ...
                  <div
                    aria-hidden
                    className="absolute inset-0 bg-gradient-to-t from-brand-green/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"
                  />
                </div>
                <div className="p-6 md:p-7 flex flex-col flex-1">
                  ...
                  <p className="text-sm text-brand-dark-text/80 leading-relaxed mb-5 flex-1">
                    {a.excerpt}
                  </p>
