  ...
  head: () => ({
    meta: [
      { title: "About — P&A Advocates LLP" },
      {
        name: "description",
        content:
          "A full-service Kenyan law firm driven by integrity, professionalism, and client commitment.",
      },
      { property: "og:title", content: "About — P&A Advocates LLP" },
      {
        property: "og:description",
        content: "Our story, vision, mission, and the values driving P&A Advocates LLP.",
      },
...
const VALUES = [
  { name: "Integrity", desc: "We uphold the highest ethical standards in every engagement." },
  {
    ...
    desc: "We bring excellence, attention to detail, and respect into every client relationship.",
  },
  ...
  return (
    <div className="page-bg-fixed">
      <PageHeader
        ...
        backgroundImage={STOCK_MEDIA.legalDesk}
      />

      <section className="py-16 md:py-24 px-6 bg-cream-veil">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12 items-center">
          <div className="flex aspect-[4/5] w-full items-center justify-center border border-brand-gold/50 bg-brand-green p-8 text-center shadow-xl">
            <div>
              <p className="mb-3 text-xs uppercase tracking-[0.3em] text-brand-gold">Our Office</p>
              <p className="font-display text-3xl text-brand-cream-text">
                Office photography coming soon
              </p>
              <p className="mt-4 text-sm leading-relaxed text-brand-cream-text/85">
                A professional office photograph will be added after the firm photoshoot.
              </p>
            </div>
          </div>
          <div>
            <p className="text-brand-gold text-xs tracking-[0.3em] uppercase mb-3">Our Story</p>
            <h2 className="font-display text-3xl sm:text-4xl text-brand-green font-semibold mb-6">
              Built on trust, delivered with rigor.
            </h2>
            <p className="text-brand-dark-text/70 text-sm sm:text-base leading-relaxed">
              P&amp;A Advocates LLP is a full-service law firm in Kenya committed to providing
              expert legal services across a wide range of practice areas. We are driven by
              integrity, professionalism, and a deep commitment to delivering tailored,
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 justify-items-center items-stretch">
          <div className="bg-white/5 p-8 md:p-10 border-t-2 border-brand-gold card-lift w-full max-w-2xl h-full">
            ...
            <p className="text-brand-cream-text font-display text-xl sm:text-2xl leading-snug">
              To be a leading legal service provider in Kenya and the wider East African region,
              known for our unwavering commitment to justice, integrity, and legal innovation.
            </p>
          </div>
          <div className="bg-white/5 p-8 md:p-10 border-t-2 border-brand-gold card-lift w-full max-w-2xl h-full">
            <p className="text-brand-gold text-xs tracking-[0.3em] uppercase mb-3">Mission</p>
            <p className="text-brand-cream-text font-display text-xl sm:text-2xl leading-snug">
              To provide exceptional legal services anchored in professionalism, responsiveness, and
              results — while building long-term partnerships based on trust and respect.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 px-6 bg-cream-veil">
        <div className="max-w-6xl mx-auto">
          <div className="bg-brand-green border-2 border-brand-gold p-8 md:p-14 lg:p-16 shadow-xl">
            <p className="text-brand-gold text-xs tracking-[0.3em] uppercase text-center mb-3">
              Core Values
            </p>
            <h2 className="font-display text-3xl sm:text-4xl text-brand-cream-text text-center font-semibold mb-12 md:mb-14">
              What We Stand For
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {VALUES.map((v) => (
                <div
                  key={v.name}
                  className="bg-white/5 p-7 md:p-8 border-l-4 border-brand-gold card-lift"
                >
